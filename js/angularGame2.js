ARACHNEST.factory("functionFactory", [
	function () {
		...
		me.iterateObjectArray = function (obj, externalFunction) {
			obj.arrayLength = obj.objValue.length;
...
ARACHNEST.factory("gameFactory", ["functionFactory", "collectionFactory", "statFactory",
	function (functionFactory, collectionFactory, statFactory) {
		...
		game.getAddRate = function (obj) {
			var upgrade = obj.objValue[obj.arrayLength],
		...
		game.setSave = function (saveData) {
...
ARACHNEST.controller("gameControl", ["$scope", "$interval", "collectionFactory", "gameFactory", "statFactory",
	function ($scope, $interval, collectionFactory, gameFactory, $localStorage) {
		...
		$scope.$storage.broodUpg = $scope.broodUpg;
		$scope.$storage.evolutionUpg = $scope.evolutionUpg;
